  ...
  return (
    <>
      <div className="flex flex-row gap-2 flex-wrap [&>*]:grow">
        <div className="shadow-sm flex flex-col items-center justify-between rounded-xl py-3 gap-2 basis-50">
          ...
          <p className="text-size14 font-weight200 text-cu-neutral-800 p-5 py-0 text-justify">
