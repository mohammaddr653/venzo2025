...
const Greetings = () => {
  return (
    <div className="relative w-full h-[100vh] bg-[#ffffff1f] bg-blend-soft-light bg-[url(/images/living_room_design_2-wallpaper-1920x1080.webp)] bg-cover bg-center bg-no-repeat">
      <div className="absolute px-5 md:px-20 w-full h-full flex items-center justify-center md:justify-end bg-gradient-to-b from-black/10 to-transparent">
